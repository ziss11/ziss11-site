...
export default function About() {
  return (
    <section id='about' className='relative z-10 py-24 px-4 md:px-[10%]'>
      <div className='max-w-[1000px] mx-auto'>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='p-6 md:p-12 bg-[#05050a]/80 border border-accent-green/20 rounded-[24px] backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.4)]'
        >
